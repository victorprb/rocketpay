defmodule Rocketpay.Accounts.Operation do
  ...
  defp handle_cast({:ok, %Decimal{ sign: 1 } = value}, balance, :deposit), do: Decimal.add(balance, value)
  defp handle_cast({:ok, %Decimal{ sign: 1 } = value}, balance, :withdraw), do: Decimal.sub(balance, value)
  defp handle_cast({:ok, _value}, _balance, _operation), do: {:error, "Invalid value"}
